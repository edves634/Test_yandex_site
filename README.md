...
**Итог:** сайт требует полной ревизии вёрстки с упором на pixel perfect по макету Figma, переработки JS-логики (удаление media.js) и добавления резиновой/адаптивной сетки. 
